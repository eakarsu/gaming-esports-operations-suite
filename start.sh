...
PORT="${PORT:-5220}"
DB_NAME="${PGDATABASE:-gaming_esports_operations_suite}"
DB_HOST="${PGHOST:-127.0.0.1}"

echo "======================================="
echo "      Gaming Esports Operations Suite"
echo "======================================="
echo
...
echo "Starting gaming esports operations suite frontend on http://localhost:$PORT"
echo "Login: admin@gaming-esports-operations.local / admin123"
