...
export const sourceSystems = [
  { name: 'AIGamingEsportsOperationsAssistant', ownership: 'Projects source capabilities and workflows', coverage: ['Projects', 'Assets', 'Calendar'] },
  { name: 'AIGamingEsportsOperationsOperations', ownership: 'Assets source capabilities and workflows', coverage: ['Scripts', 'Approvals', 'Rights'] },
  { name: 'AIGamingEsportsOperationsAnalytics', ownership: 'Calendar source capabilities and workflows', coverage: ['Publishing', 'Campaigns', 'Exceptions'] },
  { name: 'AIGamingEsportsOperationsWorkflow', ownership: 'Scripts source capabilities and workflows', coverage: ['Performance', 'Analytics', 'Reports'] },
];
