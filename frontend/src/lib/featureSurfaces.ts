...
const featureSeeds = [
  ['records', 'Projects', 'Projects operating queue', 'Content Lead', 'Review and assign next action'],
  ['assets', 'Assets', 'Assets operating queue', 'Content Lead', 'Review and assign next action'],
  ['calendar', 'Calendar', 'Calendar operating queue', 'Content Lead', 'Review and assign next action'],
  ['scripts', 'Scripts', 'Scripts operating queue', 'Content Lead', 'Review and assign next action'],
  ['approvals', 'Approvals', 'Approvals operating queue', 'Operations Lead', 'Review and assign next action'],
  ['rights', 'Rights', 'Rights operating queue', 'Operations Lead', 'Review and assign next action'],
  ['publishing', 'Publishing', 'Publishing operating queue', 'Operations Lead', 'Review and assign next action'],
  ...
  ['performance', 'Performance', 'Performance operating queue', 'Governance Lead', 'Review and assign next action'],
  ...
  ["match-analysis","Match Analysis","Match Analysis review queue","Esports Performance","Review source context and assign owner"],
  ["player-performance","Player Performance","Player Performance review queue","Esports Performance","Confirm next action and update evidence"],
  ["training-plan","Training Plan","Training Plan review queue","Esports Performance","Confirm next action and update evidence"],
  ["scrim-review","Scrim Review","Scrim Review workspace","Esports Performance Deep Workflows","Review source evidence and assign owner"],
  ["map-pick-ban-analysis","Map Pick/Ban Analysis","Map Pick/Ban Analysis workspace","Esports Performance Deep Workflows","Confirm findings, next action, and audit evidence"],
  ["player-wellness-load","Player Wellness Load","Player Wellness Load workspace","Esports Performance Deep Workflows","Confirm findings, next action, and audit evidence"],
  ["tournament-prep-plan","Tournament Prep Plan","Tournament Prep Plan workspace","Esports Performance Deep Workflows","Confirm findings, next action, and audit evidence"],
