export const AUTH_COOKIE = 'gaming_esports_operations_suite_session';
...
export const demoUsers: DemoUser[] = [
  {
    email: 'admin@gaming-esports-operations.local',
    password: 'admin123',
    firstName: 'Legal',
    lastName: 'Operator',
    role: 'admin',
  ...
  {
    email: 'manager@gaming-esports-operations.local',
    password: 'manager123',
    firstName: 'Legal',
    lastName: 'Manager',
    role: 'manager',
  ...
  {
    email: 'analyst@gaming-esports-operations.local',
    password: 'analyst123',
    firstName: 'Legal',
    lastName: 'Analyst',
    role: 'analyst',
