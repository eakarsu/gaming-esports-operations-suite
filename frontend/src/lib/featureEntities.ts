...
const entitySeeds = [
  ...
  ["match-analysis","Match Analysis Records","Match Analysis operating queue","Open","Match Analysis follow-up list","Esports Performance","$0"],
  ["player-performance","Player Performance Records","Player Performance operating queue","Review","Player Performance follow-up list","Esports Performance","$0"],
  ["training-plan","Training Plan Records","Training Plan operating queue","Review","Training Plan follow-up list","Esports Performance","$0"],
  ["scrim-review","Scrim Review Records","Scrim Review operating queue","Open","Scrim Review follow-up list","Esports Performance Deep Workflows","$0"],
  ["map-pick-ban-analysis","Map Pick/Ban Analysis Records","Map Pick/Ban Analysis operating queue","Review","Map Pick/Ban Analysis follow-up list","Esports Performance Deep Workflows","$0"],
  ["player-wellness-load","Player Wellness Load Records","Player Wellness Load operating queue","Review","Player Wellness Load follow-up list","Esports Performance Deep Workflows","$0"],
  ["tournament-prep-plan","Tournament Prep Plan Records","Tournament Prep Plan operating queue","Review","Tournament Prep Plan follow-up list","Esports Performance Deep Workflows","$0"],
