...
const features = [
  {
    ...
    summary: 'Projects workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Content',
    icon: Users,
    summary: 'Assets workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Content',
    icon: ClipboardList,
    summary: 'Calendar workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Content',
    icon: CalendarCheck,
    summary: 'Scripts workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Activity,
    summary: 'Approvals workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: Workflow,
    summary: 'Rights workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: FileText,
    summary: 'Publishing workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Operations',
    icon: ShieldCheck,
    summary: 'Campaigns workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: BarChart3,
    summary: 'Exceptions workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Governance',
    icon: PackageCheck,
    summary: 'Performance workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Bell,
    summary: 'Analytics workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    category: 'Intelligence Layer',
    icon: Files,
    summary: 'Reports workflow normalized for the Gaming Esports Operations suite with records, queues, approvals, audit, and reporting.',
  ...
  },
  {
    ...
    icon: Workflow,
    summary: "Match stats, objective control, mistakes, and tactical review.",
    bullets: ["Match Analysis queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Match Analysis", value: "28", note: 'Active' },
  ...
  },
  {
    ...
    category: "Esports Performance",
    icon: Workflow,
    summary: "Player metrics, trends, role fit, and improvement areas.",
    bullets: ["Player Performance queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Player Performance", value: "39", note: 'Active' },
  ...
  },
  {
    ...
    category: "Esports Performance",
    icon: Workflow,
    summary: "Practice plan, drills, matchup prep, and coaching notes.",
    bullets: ["Training Plan queue","AI assisted review","Audit trail"],
    metrics: [
      { label: "Training Plan", value: "50", note: 'Active' },
  ...
  },
  {
    ...
    icon: Workflow,
    summary: "Scrim outcomes, mistakes, comms notes, draft issues, and coaching priorities.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Scrim Review", value: "34", note: 'Active items' },
      { label: 'Exceptions', value: "4", note: 'Need review' },
      { label: 'Due Soon', value: "7", note: 'Next 14 days' },
    ],
  },
  {
    slug: "map-pick-ban-analysis",
    title: "Map Pick/Ban Analysis",
    href: "/map-pick-ban-analysis",
    category: "Esports Performance Deep Workflows",
    icon: Workflow,
    summary: "Opponent tendencies, map pool, draft strategy, bans, and matchup risks.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Map Pick/Ban Analysis", value: "43", note: 'Active items' },
      { label: 'Exceptions', value: "5", note: 'Need review' },
      { label: 'Due Soon', value: "8", note: 'Next 14 days' },
    ],
  },
  {
    slug: "player-wellness-load",
    title: "Player Wellness Load",
    href: "/player-wellness-load",
    category: "Esports Performance Deep Workflows",
    icon: Workflow,
    summary: "Practice load, fatigue signals, recovery, performance trend, and wellness actions.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Player Wellness Load", value: "52", note: 'Active items' },
      { label: 'Exceptions', value: "6", note: 'Need review' },
      { label: 'Due Soon', value: "9", note: 'Next 14 days' },
    ],
  },
  {
    slug: "tournament-prep-plan",
    title: "Tournament Prep Plan",
    href: "/tournament-prep-plan",
    category: "Esports Performance Deep Workflows",
    icon: Workflow,
    summary: "Opponent scouting, schedule, drills, strategy checklist, and readiness status.",
    bullets: ["Source-derived workflow","AI assisted review","Audit-ready output"],
    metrics: [
      { label: "Tournament Prep Plan", value: "61", note: 'Active items' },
  ...
  },
  {
    ...
    icon: Files,
    summary: 'Gaming Esports Operations documents, packets, evidence, attachments, and exports.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Bell,
    summary: 'Gaming Esports Operations alerts, reminders, exceptions, and approvals.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: Plug,
    summary: 'Gaming Esports Operations source-system connector health and sync status.',
  ...
  },
  {
    ...
    category: 'Core Platform',
    icon: UserRound,
    summary: 'Gaming Esports Operations users, roles, teams, permissions, and ownership settings.',
...
const aiFeatures = [
  {
    ...
    category: 'Intelligence Layer',
    icon: Bot,
    summary: 'Gaming Esports Operations assistant for triage, summaries, drafting, recommendations, and operational review.',
...
export const featureFamilies = [
  ...
  { name: 'Esports Performance', features: ["Match Analysis","Player Performance","Training Plan"] },
  { name: "Esports Performance Deep Workflows", features: ["Scrim Review","Map Pick/Ban Analysis","Player Wellness Load","Tournament Prep Plan"] },
...
export const featureContexts: Record<string, FeatureContext> = Object.fromEntries(
  allFeatures.map((feature) => [
    feature.title,
    {
      sourceOwners: ['AIGamingEsportsOperationsAssistant', 'AIGamingEsportsOperationsOperations where applicable'],
