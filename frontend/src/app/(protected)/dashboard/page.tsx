...
export default function DashboardPage() {
  return (
    <UnifiedShell
      ...
      title="Gaming Esports Operations Dashboard"
      subtitle="One merged gaming esports operations view for Projects, Assets, Calendar, Scripts, Approvals, documents, audit, and AI."
    >
      ...
      <div className="grid columns-2">
        <div className="card stack">
          ...
          <div className="muted">
            This suite removes project-based navigation and groups shared gaming esports operations jobs into one surface. Projects, Assets, Calendar, Scripts, Approvals, Rights, documents, audit, and AI are presented as platform features.</div>
