const baseUrl = process.env.SMOKE_BASE_URL || 'http://127.0.0.1:5220';
...
const adminCookie = await login('admin@gaming-esports-operations.local', 'admin123');
const managerCookie = await login('manager@gaming-esports-operations.local', 'manager123');
const analystCookie = await login('analyst@gaming-esports-operations.local', 'analyst123');
